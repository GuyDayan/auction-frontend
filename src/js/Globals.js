...
export const GET_PRODUCT_DETAILS_REQUEST_PATH = 'get-product-details';
export const GET_MANAGE_DETAILS_REQUEST_PATH = 'get-manage-details';
...
export const ERROR_EMAIL_NOT_VALID = 1011;
export const ERROR_FULLNAME_NOT_VALID = 1012;
